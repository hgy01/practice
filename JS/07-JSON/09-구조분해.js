...
//data안에 있는 height와 weight를 분해해서 이름을 h와 w로 변경
const {height: h, weight:w}=data;
console.log(h);
console.log(w);
console.log(data);

//구조분해를 수행한 나머지를 별도로 분리하기-->'rest_b'라는 것은 단순한 변수 이름이므로 다른 단어를 사용해도 무관
const dummy={a1:100, a2:200, ae:300, a4:400};
...
const origin={name: 'javasecript', age:25};
